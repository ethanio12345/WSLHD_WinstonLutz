...
Provide a one-click Winston-Lutz analysis flow for routine QA. Physicist selects a machine, the app auto-selects the newest runfolder, runs pylinac with centre defaults, and writes a MyQA-importable paired xltx+xlsx. Errors are surfaced as physicist-friendly messages, never raw stack traces.
## Requirements
